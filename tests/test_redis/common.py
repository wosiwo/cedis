...
all_redis = [
        RedisServer('127.0.0.1', 6379, '/tmp/r/redis-2100/', CLUSTER_NAME, 'redis-2100'),
        RedisServer('127.0.0.1', 6379, '/tmp/r/redis-2101/', CLUSTER_NAME, 'redis-2101'),
        ]

nc = NutCracker('127.0.0.1', 6379, '/tmp/r/nutcracker-4100', CLUSTER_NAME,
